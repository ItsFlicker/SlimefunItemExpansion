...
public class MouseTail extends SimpleSlimefunItem<ItemUseHandler> implements NotPlaceable, RandomMobDrop {
    ...
    private final ItemSetting<Boolean> dropSetting = new ItemSetting<>(this, "drop-from-silverfish", true);
    private final ItemSetting<Integer> chance = new IntRangeSetting(this, "silverfish-drop-chance", 0, 5, 100);
