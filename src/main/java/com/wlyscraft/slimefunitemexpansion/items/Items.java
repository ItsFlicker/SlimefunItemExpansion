...
//  材料
    ...
    public static SlimefunItemStack ORIGINAL_MOB_MATERIAL = new SlimefunItemStack("ORIGINAL_MOB_MATERIAL", Material.SNOWBALL, "&6原始怪物物质", "&b在血夜时击杀怪物有25%几率掉落");
...
//  工具和武器装备
    ...
    public static SlimefunItemStack LIGHTNING_BOW = new SlimefunItemStack("LIGHTNING_BOW", Material.BOW, "§b§l闪电弓", "被此弓射出去的箭击中", "将会被一道雷劈中");
    ...
    public static SlimefunItemStack ANDURIL = new SlimefunItemStack("ANDURIL", Material.IRON_SWORD, "§aAndúril");
...
//  杂项
    ...
    public static SlimefunItemStack HOPE_FLOWER = new SlimefunItemStack("HOPE_FLOWER", Material.POPPY, "希望之花", "§7所以说,不要停下来啊...");
    ...
    public static Category IE_MACHINES_STUFF
            ...
            new CustomItem(Items.MACHINE_BLOCK, "物品拓展 - 机械"));
    ...
    public static Category IE_MATERIAL_STUFF
            = new Category(new NamespacedKey(SlimefunItemExpansion.getInstance(), "IE_MATERIAL_STUFF"),
            new CustomItem(Items.OSGLOGLAS_INGOT, "物品拓展 - 材料"));
